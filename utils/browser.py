...
from playwright.async_api import Page, Error, Browser, async_playwright
...
async def launch_browser(**kwargs) -> Browser:
    return await _playwright.chromium.launch(**kwargs)  # type: ignore
...
async def shutdown_browser():
    await _browser.close()  # type: ignore
